...
public class ViewAdminHome {
	...
	*/
	...
	protected static Button button_ListUsers = new Button("List/Delete Users");
	...
	*/
	...
	private ViewAdminHome() {
		...
		button_SendInvitation.getStyleClass().addAll("success");
		button_SendInvitation.setOnAction((event) -> {ControllerAdminHome.performInvitation(); });
	
		// GUI Area 4
		setupButtonUI(button_ManageInvitations, "Dialog", 16, 350, Pos.CENTER, 20, 270);
		button_ManageInvitations.getStyleClass().addAll("accent", "button-outlined");
		button_ManageInvitations.setOnAction((event) -> 
			{ControllerAdminHome.manageInvitations(); });
	
		setupButtonUI(button_SetOnetimePassword, "Dialog", 16, 350, Pos.CENTER, 20, 320);
		button_SetOnetimePassword.getStyleClass().addAll("accent", "button-outlined");
		button_SetOnetimePassword.setOnAction((event) -> 
			{ControllerAdminHome.setOnetimePassword(); });

		setupButtonUI(button_ListUsers, "Dialog", 16, 350, Pos.CENTER, width/2 + 30, 270);
		button_ListUsers.getStyleClass().addAll("accent", "button-outlined");
		button_ListUsers.setOnAction((event) -> {ControllerAdminHome.listUsers(); });

		setupButtonUI(button_AddRemoveRoles, "Dialog", 16, 350, Pos.CENTER, width/2 + 30, 320);
		button_AddRemoveRoles.getStyleClass().addAll("accent", "button-outlined");
