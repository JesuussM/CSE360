...
// NEW: import the admin OTP window
import guiOtp.AdminIssueOtpWindow;
...
public class ControllerAdminHome {
	...
	*/
	 ...
	 * 
	 * <p> Description: Opens the admin OTP window so the admin can generate a one-time code
	 * for a username and set an expiry. </p>
	 */
	protected static void setOnetimePassword () {
		// Launch the OTP dialog on the same Stage as Admin Home
		AdminIssueOtpWindow.show(ViewAdminHome.theStage);
	}
	...
	protected static boolean invalidEmailAddress(String emailAddress) {
		InputValidation.inputLine = emailAddress;
		boolean ValidEmailAddress = InputValidation.ValidateEmailAddress();
		if (!ValidEmailAddress) {
			ViewAdminHome.alertEmailError.setContentText(
					InputValidation.emailAddressErrorMessage);
			ViewAdminHome.alertEmailError.showAndWait();
			return true;
		}
		return false;
