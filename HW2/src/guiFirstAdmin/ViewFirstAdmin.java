...
public class ViewFirstAdmin {
	...
	private ViewFirstAdmin() {
		...
		setupTextUI(text_AdminUsername, "Arial", 18, 300, Pos.BASELINE_LEFT, 275, 250, 
				true);
		...
		setupTextUI(text_AdminPassword1, "Arial", 18, 300, Pos.BASELINE_LEFT, 275, 300, 
				true);
		...
		// Establish the text input operand field for the password
		setupTextUI(text_AdminPassword2, "Arial", 18, 300, Pos.BASELINE_LEFT, 275, 350, 
				true);
		...
		setupButtonUI(button_AdminSetup, "Dialog", 18, 250, Pos.CENTER, 300, 470);
		button_AdminSetup.getStyleClass().add("success");
		...
		setupLabelUI(label_PasswordsDoNotMatch, "Arial", 18, width, Pos.CENTER, 30, 400);
		label_PasswordsDoNotMatch.getStyleClass().add("danger");
