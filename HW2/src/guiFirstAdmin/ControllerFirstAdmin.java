...
public class ControllerFirstAdmin {
	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
		...
		InputValidation.inputLine = adminUsername;
		boolean validUsername = InputValidation.ValidateUsername();
		InputValidation.inputLine = adminPassword1;
		boolean validPassword = InputValidation.ValidatePassword();
		...
		if (validUsername && validPassword) {
			...
			inputValidation.InputValidation.ErrorAlert.setTitle("Error");
			inputValidation.InputValidation.ErrorAlert.setContentText(
					inputValidation.InputValidation.userNameRecognizerErrorMessage);
			inputValidation.InputValidation.ErrorAlert.showAndWait();
		} else {
			inputValidation.InputValidation.ErrorAlert.setTitle("Error");
			inputValidation.InputValidation.ErrorAlert.setContentText(
					inputValidation.InputValidation.passwordErrorMessage);
			inputValidation.InputValidation.ErrorAlert.showAndWait();
		}
