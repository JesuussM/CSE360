 ...
 */	
	...
	public static void main(String[] args) {
		...
		// Positive Tests
		performTestCase(6, "0.13", true);
		performTestCase(7, ".234", true);
		performTestCase(8, "3.14", true);
		performTestCase(9, "1234.56", true);
		performTestCase(10, "0.12345", true);
		
		// Negative Tests
		performTestCase(11, "A1", false);
		performTestCase(12, "012Z34", false);
		performTestCase(13, "12+14", false);
		performTestCase(14, "12*34", false);
		performTestCase(15, "abcd", false);
