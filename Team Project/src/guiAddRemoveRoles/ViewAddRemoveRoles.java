...
public class ViewAddRemoveRoles {
	...
	*/
	...
	public ViewAddRemoveRoles() {
		...
		theAddRemoveRolesScene.getStylesheets().add(getClass().getResource("/cupertino-dark.css").toExternalForm());
		...
		button_AddRole.getStyleClass().addAll("success");
		...
		button_RemoveRole.getStyleClass().addAll("danger");
